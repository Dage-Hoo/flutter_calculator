...
class DataStruct {
  final Expr currentExpr;
  final List<(Expr, String)> historyExpr;

  const DataStruct({
    required this.currentExpr,
    required this.historyExpr,
  });
}

class Expr {
  final List<(ExprType, String)> exprList;
  int lBracketCount;
  int rBracketCount;

  Expr({
    required this.exprList,
    required this.lBracketCount,
    required this.rBracketCount,
  });
}
